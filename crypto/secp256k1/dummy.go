...
import (
	_ "github.com/tenderly/net-mantle/crypto/secp256k1/libsecp256k1/include"
	_ "github.com/tenderly/net-mantle/crypto/secp256k1/libsecp256k1/src"
	_ "github.com/tenderly/net-mantle/crypto/secp256k1/libsecp256k1/src/modules/recovery"
)
