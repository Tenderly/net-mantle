...
import (
	...
	"github.com/tenderly/net-mantle/crypto/signify"
	"github.com/tenderly/net-mantle/internal/build"
	"github.com/tenderly/net-mantle/internal/download"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/tenderly/net-mantle/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/tenderly/net-mantle/internal/version.gitDate="+env.Date)
	}
	if env.Tag != "" {
		ld = append(ld, "-X", "github.com/tenderly/net-mantle/internal/version.gitTag="+env.Tag)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/tenderly/net-mantle/core/rawdb", "github.com/tenderly/net-mantle/ethdb/leveldb"},
		{"github.com/tenderly/net-mantle/core/rawdb", "github.com/tenderly/net-mantle/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
