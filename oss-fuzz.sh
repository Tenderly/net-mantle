...
coverpkg="github.com/tenderly/net-mantle/..."
...
repo=$GOPATH/src/github.com/tenderly/net-mantle
compile_fuzzer github.com/tenderly/net-mantle/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/tenderly/net-mantle/common/bitutil \
...
compile_fuzzer github.com/tenderly/net-mantle/core/vm/runtime \
  FuzzVmRuntime fuzzVmRuntime\
  $repo/core/vm/runtime/runtime_fuzz_test.go

compile_fuzzer github.com/tenderly/net-mantle/core/vm \
  FuzzPrecompiledContracts fuzzPrecompiledContracts\
  $repo/core/vm/contracts_fuzz_test.go,$repo/core/vm/contracts_test.go

compile_fuzzer github.com/tenderly/net-mantle/core/types \
  FuzzRLP fuzzRlp \
  $repo/core/types/rlp_fuzzer_test.go

compile_fuzzer github.com/tenderly/net-mantle/crypto/blake2b \
  Fuzz fuzzBlake2b \
  $repo/crypto/blake2b/blake2b_f_fuzz_test.go

compile_fuzzer github.com/tenderly/net-mantle/accounts/keystore \
  FuzzPassword fuzzKeystore \
  $repo/accounts/keystore/keystore_fuzzing_test.go

pkg=$repo/trie/
compile_fuzzer github.com/tenderly/net-mantle/trie \
  FuzzTrie fuzzTrie \
...
compile_fuzzer github.com/tenderly/net-mantle/eth/protocols/snap \
...
compile_fuzzer github.com/tenderly/net-mantle/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/tenderly/net-mantle/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/tenderly/net-mantle/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/tenderly/net-mantle/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
  $repo/tests/fuzzers/secp256k1/secp_test.go

compile_fuzzer github.com/tenderly/net-mantle/eth/protocols/eth \
