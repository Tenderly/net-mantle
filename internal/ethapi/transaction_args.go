...
import (
	...
	"github.com/tenderly/net-mantle/consensus/misc/eip4844"
...
type TransactionArgs struct {
	...
	// Issue detail: https://github.com/tenderly/net-mantle/issues/15628
...
func (args *TransactionArgs) setFeeDefaults(ctx context.Context, b Backend, head *types.Header) error {
	...
	// other tx values. See https://github.com/tenderly/net-mantle/pull/23274
